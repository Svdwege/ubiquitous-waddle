...
/* If omitted from header, declare overrideable prototypes here so they're
 * ready for use */
...
/*-----------------------------------------------*/
static void UnityPrintExpectedAndActualStringsLen(
                             ...
                             const UNITY_FLOAT_TRAIT_T style)
{
   ...
   switch (style)
   {
      ...
      case UNITY_FLOAT_IS_DET: /* A determinate number is non infinite and
                                  not NaN. */
